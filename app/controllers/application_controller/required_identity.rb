...
module ApplicationController::RequiredIdentity
  ...
  # (e.g. <tt>:confirmed</tt>, <tt>:email</tt>, <tt>:twitter</tt>, <tt>:facebook</tt>, <tt>:google</tt>, <tt>:linkedin</tt>, <tt>:login</tt>, <tt>:any</tt>)
  # and defaults to :any.
  #
  ...
  REQUESTBALE_IDENTITIES = [ :confirmed, :email, :twitter, :facebook, :google, :linkedin, :address, :login, :any ]
